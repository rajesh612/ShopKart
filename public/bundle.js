...
function iphoneReducer(state, action) {
...
var combineReducer = combineReducer({
    iphoneCount: iphoneReducer,
    laptopCount: laptopReducer,
    cameraCount: cameraReducer,
...
var store = (0, _redux.createStore)(combineReducer, initialState);
...
/* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__(21), __webpack_require__(50)(module)))
...
var _ProductDetails = __webpack_require__(70);

var _ProductDetails2 = _interopRequireDefault(_ProductDetails);

var _PriceDetails = __webpack_require__(71);

var _PriceDetails2 = _interopRequireDefault(_PriceDetails);
    ...
    value: function render() {
      return _react2.default.createElement(
        ...
        _react2.default.createElement(
          'div',
          { className: 'container well' },
          _react2.default.createElement(_PriceDetails2.default, null)
        )
      );
    }
  }]);
...
App.childContextTypes = {
  contextCounter: _propTypes2.default.number,
  contextFnc: _propTypes2.default.func
};
//export App;
...
var PriceDetails = function (_React$Component) {
    _inherits(PriceDetails, _React$Component);

    function PriceDetails() {
        _classCallCheck(this, PriceDetails);

        return _possibleConstructorReturn(this, (PriceDetails.__proto__ || Object.getPrototypeOf(PriceDetails)).apply(this, arguments));
    }
